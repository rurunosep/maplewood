// ------------------------------------
// Auto-generated by quicktype from the LDtk 1.3.3 minimal JSON schema
// ------------------------------------
...
pub struct Project {
    ...
    /// option to enable the change immediately.<br/><br/>  Height of the world grid in
    /// pixels.
    ...
    /// **WARNING**: this field will move to the `worlds` array after the "multi-worlds"
    /// update. It will then be `null`. You can enable the Multi-worlds advanced project
    /// option to enable the change immediately.<br/><br/>  Width of the world grid in
    /// pixels.
...
pub struct LayerDefinition {
    ...
    /// **WARNING**: some layer *instances* might use a different tileset. So most of the
    /// time, you should probably use the `__tilesetDefUid` value found in layer
    /// instances.<br/>  Note: since version 1.0.0, the old `autoTilesetDefUid` was
    /// removed and merged into this value.
...
pub struct EntityInstance {
    ...
    /// Optional TilesetRect used to display this entity (it could either be the default
    /// Entity tile, or some tile provided by a field value, like an Enum).
    #[serde(rename = "__tile")]
    pub tile: Option<TilesetRectangle>,
...
pub struct LayerInstance {
    ...
    /// sorted in display order (ie. 1st tile is beneath 2nd, which is beneath 3rd
...
pub struct Level {
    ...
    /// An array listing all other levels touching this one on the world map.<br/>  Only
    /// relevant for world layouts where level spatial positioning is manual (ie.
    /// GridVania, Free). For Horizontal and Vertical layouts, this array is always empty.
    ...
    /// spatial positioning is manual (ie. GridVania, Free). For Horizontal and Vertical
    /// layouts, the value is always -1 here.
    #[serde(rename = "worldX")]
    pub world_x: i64,

    /// World Y coordinate in pixels.<br/>  Only relevant for world layouts where level
    /// spatial positioning is manual (ie. GridVania, Free). For Horizontal and Vertical
    /// layouts, the value is always -1 here.
    #[serde(rename = "worldY")]
    pub world_y: i64,
